...
def criar_conta(numero_conta, agencia,usuarios):
    ...
    CPF_ja_existe = filtrar_usuario(CPF, usuarios)

    if CPF_ja_existe:
        print("conta criada.")
        conta_criada = {"agencia": agencia, "numero_conta":numero_conta, "usuarios":usuarios}
        print(conta_criada)
        return conta_criada
    else:
        print("O cpf não existe, crie um novo usuario primeiro")
...
def criar_usuario(usuarios):
    ...
    if CPF_ja_existe:
        ...
        usuarios.append({"CPF": CPF, "Nome": nome, "Data_nasc":data_nascimento, "End": endereco})
...
while True:
    ...
    if valor == "D":
        ...
        conta_criada = criar_conta(numero_conta, agencia,usuarios)
